...
def add_stock(username):
    try:
        ...
        print("Error: You do not have the necessary permissions to add stock.")
    except ValueError:
        print("Invalid input. Please enter valid numeric values for quantity and price.")
    except Exception as e:
...
def check_inventory(username):
    try:
        ...
        print("Error: You do not have the necessary permissions to check the inventory.")
    except Exception as e:
        print(f"An unexpected error occurred: {e}")
...
def remove_stock(username):
    try:
        ...
        print("Error: You do not have the necessary permissions to remove stock.")
    except ValueError:
        print("Invalid input. Please enter valid numeric values for quantity.")
    except Exception as e:
        print(f"An unexpected error occurred: {e}")
...
def select_shop():
    try:
        ...
        print(f"An unexpected error occurred while selecting shop: {e}")
...
class OrderSystem:
    def check_out_order(self, username):
        try:
            ...
            print(f"An unexpected error occurred while checking out order: {e}")
    ...
    def display_orders(self, username):
        try:
            ...
            print(f"An unexpected error occurred while displaying orders: {e}")
    ...
    def cancel_order(self, username):
        try:
            ...
            print(f"An unexpected error occurred while canceling order: {e}")
    ...
    def deliver_order(self, username):
        try:
            ...
            print(f"An unexpected error occurred while delivering order: {e}")
...
def add_static_shops():
    try:
        ...
        print(f"An unexpected error occurred while adding static shops: {e}")
...
def main():
    try:
        ...
        while True:
            ...
            elif choice == '5' and user_role == 'seller':
                remove_stock(username)
